...
export const metadata: Metadata = {
  ...
  keywords: ["сервиз ауди", "сервиз бмв", "сервиз мерцедес", "автосервиз", "сервиз", "диагностика", "ремонт на кола", "пътна помощ", "тунинг", "тунинг пловдив", "пътна помощ пловдив", "сервиз пловдив", "смяна на гуми пловдив", "смяна на масло пловдив", "автосервиз пловдив"]
};
