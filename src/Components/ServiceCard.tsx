...
const ServiceCard: React.FC<Service> = (service) => {
   ...
   return (
        ...
        <a
            href={service?.link}
            className={`px-2 py-4 transition duration-300 group flex flex-col justify-between gap-2 items-center text-white rounded-lg border border-white border-opacity-15 flex-1 w-[98%] h-[350px] hover:translate-y-[-3px] hover:border-opacity-100 ${
