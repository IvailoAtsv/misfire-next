...
const services: Service[] = [
    { label: 'Тунинг услуги за всички автомобили. ', description:'Предлагаме висококачествени тунинг услуги за всички видове автомобили. Доверете се на нашите експерти за оптимална производителност.', src: '/turbo.svg', link: '/tuning', clickable: true },
    ...
    { label: 'Диагностика', description:"Лицензирана диагностика за BMW, RR, Mini, Audi, Volkswagen, Skoda, Seat, Bentley, Lamborghini, Man. Разполагаме и с универсална диагностика за всички марки и видове автомобили.", src: '/diagnostics.svg' },
    ...
    { label: 'Автоклиматици', description:'Предлагаме диагностика, ремонт и зареждане на автоклиматици.', src: 'snowflake.svg' },
];
