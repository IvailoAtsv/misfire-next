...
export const About = () => {
    ...
    return (
        ...
        <section className="w-full px-4 mt-10 mb-36 bg-background text-white min-h-[80vh]">
                    ...
                    <div className="w-full z-20 bg-transparent text-center md:text-left py-4 flex-1">
                        <div className="mt-10 lg:mt-0 w-full">
                            ...
                            <p className="mb-5 bg-transparent opacity-75">
                               Предлагаме професионални услуги, гаранция за качество и конкурентни цени. Ако се доверите на нашия опит и знания с вашия автомобил, Вие ще искате да се върнете, но автoмобила ви няма да ви дава повод.
                            </p>
