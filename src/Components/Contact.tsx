  ...
  return (
    <Animation maxW='3440px' moveY={120} opacity={0.6} start={0.7}>
      <div className="relative py-6 max-w-[3440px] mx-auto w-full h-auto bg-accent flex justify-center items-center">
        ...
        />
        <section className="w-full gap-3 lg:max-h-[700px] bg-accent rounded-lg max-w-7xl min-h-[70vh] flex-col lg:flex-row items-center flex justify-center">
          <form onSubmit={handleSubmit(onSubmit)} className="text-white max-w-3xl font-normal w-full flex-1 h-full flex p-2 gap-3 flex-col justify-between items-start">
